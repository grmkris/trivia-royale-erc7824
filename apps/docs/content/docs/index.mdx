...
<Cards>
  <Card
    ...
    description="Learn state channels through a complete multiplayer game implementation. Covers core concepts, building blocks, and patterns."
    href="/docs/trivia-royale"
  />
  <Card
    title="Quick Start"
  ...
  <Card
    ...
    href="/docs/quick-start/initializing-channel"
  />
  <Card

...
For more details on WebSocket RPC patterns and how ClearNode communication works, see **[ClearNode Communication](./clearnode-communication)**.
...
For details on channel state structure, proof states, and session key management, see **[ClearNode Communication](./clearnode-communication)**.
...
- **[ClearNode Communication](./clearnode-communication)**: Deep dive into WebSocket RPC patterns, state management, and session keys
